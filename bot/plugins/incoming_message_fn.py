...
async def incoming_start_message_f(bot, update):
        ...
        try:
            ...
            if user.status == "kicked":
                await message.reply_text(
                    text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/Dulquer_Salmaan_lovers).",
                    parse_mode="markdown",
            ...
            await message.reply_text(
                text="Something went Wrong. Contact my [Support Group](https://t.me/Dulquer_Salmaan_lovers).",
                parse_mode="markdown",
                disable_web_page_preview=True
            )
            return
    await bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('🗣️Group', url='https://t.me/Dulquer_Salmaan_lovers'),
                    InlineKeyboardButton('📢Channel', url='https://t.me/Dulquer_Salmaan_lovers'),
                    InlineKeyboardButton('✳️Source', url='https://github.com/BAGBOY555/MT-VideoCompress')
                ],
                [
